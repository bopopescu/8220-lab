...
class Deploy(base.Command):
  ...
  def Args(parser):
    ...
    trigger_http = trigger_group.add_argument(
        ...
        help='Add an HTTP trigger for this function')
    trigger_http.detailed_help = (
        'Every HTTP POST operation to the URL '
        'generated by the GCF and inserted to (output only) field '
        'web_trigger.url will trigger function execution. Result of '
        'the function will be returned in response body.')
